...
var exp_len = 210 //multiple of numTrialsPerBlock
var numTrialsPerBlock = 42 // multiple of 7 (6go:1nogo)
var numTestBlocks = exp_len / numTrialsPerBlock

var block_stims = jsPsych.randomization.repeat(practice_stimuli, refresh_len / practice_stimuli.length); 
...
for (var i = 0; i < refresh_len; i ++){
	...
	refreshTrials.push(prompt_fixation_block)
